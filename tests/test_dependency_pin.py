...
def test_lib_python_worktree_pinned_to_v0_3_5():
    installed = version("lib-python-worktree")
    assert installed == "0.3.5", (
        f"expected lib-python-worktree==0.3.5, but installed version is {installed!r}. "
        ...
        f'"lib-python-worktree @ git+https://github.com/Seretos/lib-python-worktree@v0.3.5"'
    )
