...
def test_lib_python_worktree_pinned_to_v0_3_9():
    installed = version("lib-python-worktree")
    assert installed == "0.3.9", (
        f"expected lib-python-worktree==0.3.9, but installed version is {installed!r}. "
        ...
        f'"lib-python-worktree @ git+https://github.com/Seretos/lib-python-worktree@v0.3.9"'
    )
